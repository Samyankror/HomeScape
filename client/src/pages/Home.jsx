    ...
    return (
        ...
        <div>
            <div className="flex flex-col gap-8 py-28 px-3 max-w-6xl mx-auto">
                <h1 className='text-slate-700 font-bold text-6xl'>Your dream home is <br/>just a click away
                    <span className='opacity-70 '> </span><br /></h1>
                <p className='text-slate-600 text-lg font-semibold'>
                    At HomeScape, we connect you with properties that feel like home. <br/>
Whether you're looking to rent or buy, we've got the perfect match for you.
                </p>
                <Link to={'/search'}
