...
function CreateListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await fetchWithAuth("/api/listing/create", {
        method: "POST",
        headers: {
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex gap-6  flex-wrap">
            <div className="flex gap-2">
              ...
              />
              <label htmlFor="sale" className=" text-md font-semibold">
                Sale
              </label>
            </div>
            ...
            <div className="flex gap-2">
              ...
              />
              <label htmlFor="rent" className=" text-md font-semibold">
                Rent
              </label>
            </div>
            ...
            <div className="flex gap-2">
              ...
              />
              <label htmlFor="parking" className=" text-md font-semibold">
                Parking Spot
              </label>
            </div>
            ...
            <div className="flex gap-2">
              ...
              />
              <label htmlFor="furnished" className=" text-md font-semibold">
                Furnished
              </label>
            </div>
            ...
            <div className="flex gap-2">
              ...
              />
              <label htmlFor="offer" className=" text-md font-semibold">
                Offer
              </label>
            </div>
          </div>
          ...
          <div className="flex gap-8 flex-wrap">
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="bedrooms" className=" text-md font-semibold">
                Beds
              </label>
            </div>
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="bathrooms" className=" text-md font-semibold">
                Baths
              </label>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col  flex-1 gap-4 ">
          ...
          <p className="text-red-700">
            {imageUploadError ? "Image should be less than 2mb" : null}
          </p>
